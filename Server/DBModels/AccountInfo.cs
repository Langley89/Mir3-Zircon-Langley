...
namespace Server.DBModels
{
    ...
    public sealed class AccountInfo : DBObject
    {
        ...
        protected override void OnCreated()
        {
            ...
            buff.TickFrequency = TimeSpan.FromMinutes(20);
            buff.Stats = new Stats { [Stat.AvailableHuntGoldCap] = 5 };
        ...
        protected override void OnLoaded()
        {
            ...
            Buffs.First(x => x.Type == BuffType.HuntGold).Stats = new Stats { [Stat.AvailableHuntGoldCap] = 5 };
            Buffs.First(x => x.Type == BuffType.HuntGold).TickFrequency = TimeSpan.FromMinutes(20);
        }
