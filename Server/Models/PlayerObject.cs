...
namespace Server.Models
{
    public sealed class PlayerObject : MapObject
    {
        ...
        public void ItemUse(CellLinkInfo link)
        {
            ...
            switch (item.Info.ItemType)
            {
                ...
                case ItemType.Book:
                    ...
                    {
                        int rate = (magic.Level - 2) * Globals.Level4Exp;
        ...
        public void ApplyObserverBuff()
        {
            ...
            stats[Stat.DropRate] += 2;
            stats[Stat.GoldRate] += 2;
        ...
        public void ApplyGuildBuff()
        {
            ...
            {
                stats[Stat.ExperienceRate] += 4;
                stats[Stat.DropRate] += 3;
                stats[Stat.GoldRate] += 3;
            }
            else if (Character.Account.GuildMember.Guild.Members.Count <= 30)
            {
                stats[Stat.ExperienceRate] += 3;
                stats[Stat.DropRate] += 3;
                stats[Stat.GoldRate] += 3;
            }
