    ...
    public sealed class MagicCell : DXControl
    {
        ...
        private void ExperienceBarAfterDraw(object sender, EventArgs e)
        {
            ...
            switch (magic.Level)
            {
                ...
                default:
                    if (magic.Info.Experience3 == 0) return;
                    percent = (float)Math.Min(1, Math.Max(0, magic.Experience / (decimal)((magic.Level - 2) * Globals.Level4Exp)));
                    break;
            }
                ...
                else
                {
                    ...
                    switch (magic.Level)
                    {
                        ...
                        case 2:
                            ...
                            break;
                        default:
                            ExperienceLabel.Text = $"Experience: {magic.Experience}/{(magic.Level - 2) * Globals.Level4Exp}";
                            break;
                    }
